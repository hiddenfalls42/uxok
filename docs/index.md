...
The name points at a sharper lineage than "microkernel" alone. By structure uxok is a microkernel, but its capability system follows the MIT exokernel's discipline — *mechanism, not policy*, resources reached through secure bindings, abstraction pushed out into plugins. It stops short of the exokernel's hardware protection: plugins share one process and one trust domain. [Microkernel or exokernel?](explanation/architecture-overview.md#microkernel-or-exokernel) draws the line.
