...
class TestCoreLifecycle:
    ...
    @pytest.mark.asyncio
    async def test_stop_with_plugins(self, clean_core):
        core = clean_core
    ...
    @pytest.mark.asyncio
    async def test_precache_hooks(self, clean_core):
        core = clean_core
...
class TestCoreStopOrder:
    ...
    @pytest.mark.asyncio
    async def test_stop_respects_reverse_dependency_order(self, clean_core):
...
class TestCoreCapabilities:
    @pytest.mark.asyncio
    async def test_list_capabilities(self, clean_core):
    ...
    @pytest.mark.asyncio
    async def test_get_capability_info(self, clean_core):
...
class TestStopIsTeardown:
    ...
    @pytest.mark.asyncio
    async def test_stop_empties_the_registry(self, clean_core):
        core = clean_core
    ...
    @pytest.mark.asyncio
    async def test_on_stop_runs_during_teardown(self, clean_core):
        stopped = []
    ...
    @pytest.mark.asyncio
    async def test_restart_accepts_a_fresh_plugin_graph(self, clean_core):
        core = clean_core
    ...
    @pytest.mark.asyncio
    async def test_teardown_unregisters_dependents_before_dependencies(self, clean_core):
        order = []
...
class TestDuplicateRegistration:
    ...
    @pytest.mark.asyncio
    async def test_double_register_raises_and_preserves_plugin(self, clean_core):
        import asyncio
